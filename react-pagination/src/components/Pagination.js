  ...
  return (
    <ul className="pagination justify-content-center">
      <li className="page-item">
        <button className={currentPage === 1 ? "page-link disabled" : "page-link"} disabled={currentPage === 1} onClick={() => prevClick(currentPage)}>
      ...
      {paginationRange.map( (page, i) => {
        ...
        return <li key={i} className={page === currentPage ? "page-item active" : "page-item"} selected={page === currentPage} onClick={() => onPageChange(page)}>
                <span className="page-link">{page}</span>
              </li>
      })}
      <li className="page-item">
        <button className={currentPage === lastPage ? "page-link disabled" : "page-link"} disabled={currentPage === lastPage} onClick={() => nextClick(currentPage)}>
